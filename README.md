...
перезапуска приложения в чате появляется инструмент `analyze_vk_video`: он качает
ролик у вас на машине и возвращает в чат название, транскрипт и кадры картинками.
Кадров по умолчанию 6, а не 40: каждая картинка стоит контекста.
