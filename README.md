...
```
Вы:   разбери https://vkvideo.ru/video-18403220_456239696,
...
Клод: [python scripts/vk_fetch.py …]  скачиваю (<= 480p)… аудио 16 кГц моно…
      ...
      Ролик про отмену научных грантов в США и релиз DeepSeek.

      • 00:42 — гранты NIH заморожены, что это значит для лабораторий
      • 07:15 — DeepSeek R1: почему дешевле обучения OpenAI (слайд с графиком цен)
      • 21:03 — история с читерством в Path of Exile 2
```
